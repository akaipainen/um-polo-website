...
import Body from './AboutUsInternals/AboutUsBody'
...
<div>
      <Header highlight = "about us"/>
      <div className="header">
  <div className="myBigLogo">
    <div></div><img className = "informalLogo" alt = "banner"onClick={()=> window.open(`${process.env.PUBLIC_URL}/`, "_self")} src = {`${process.env.PUBLIC_URL}/Icons/informalLogo.svg`}></img><div></div>
    </div>
  ...
  <ul className="menu">
    ...
    <li><a className = "selectedFont" href={`${process.env.PUBLIC_URL}/aboutus`}>About Us</a></li>
