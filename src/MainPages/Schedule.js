...
import Body from './ScheduleInternals/ScheduleBody'
...
<div>
  ...
  <ul className="menu">
    ...
    <li><a className = "selectedFont" href={`${process.env.PUBLIC_URL}/scheduleandresults`}>Schedule and Results</a></li>
