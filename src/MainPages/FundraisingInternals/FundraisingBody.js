    ...
    return (
        <div>
            ...
            {Fundraising.map(post => {
                ...
                <br></br><p>{"\t"}If you would like to make a monetary donation contributions can be made through the Men’s Club Water Polo online giving page <a  style={{color:"black"}}href="https://leadersandbest.umich.edu/find/#!/give/basket/fund/311008" rel="noopener noreferrer" target="_blank">here</a>. If you would like to make a non-monetary donation please <a href={`${process.env.PUBLIC_URL}/contactus/`} style={{color:"black"}} rel="noopener noreferrer" target="_blank">contact us</a>.</p>
                <br></br><p>Thank you for your generous support!</p>
